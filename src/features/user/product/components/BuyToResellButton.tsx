  ...
  return (
    <>
      <Button
        ...
        disabled={isDisabled || isBuyingToResell}
        aria-disabled={isDisabled || isBuyingToResell}
      >
        {isBuyingToResell ? (
