        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 sm:pt-16 md:pt-20 lg:pt-20 xl:pt-20 pb-16 sm:pb-20 md:pb-24 lg:pb-32 xl:pb-32">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 lg:gap-12 xl:gap-12 items-center">
            ...
            <div className="space-y-6 sm:space-y-8 md:space-y-8 lg:space-y-8 xl:space-y-8">
              {/* Badge */}
              <div className={`inline-flex items-center space-x-2 px-3 py-2 sm:px-4 sm:py-2 md:px-4 md:py-2 lg:px-4 lg:py-2 xl:px-4 xl:py-2 bg-flyverr-primary text-white text-xs sm:text-sm md:text-sm lg:text-sm xl:text-sm font-medium rounded-full shadow-lg transform transition-all duration-700 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
                <Sparkles className="w-3 h-3 sm:w-4 sm:h-4 md:w-4 md:h-4 lg:w-4 lg:h-4 xl:w-4 xl:h-4" />
                <span className="text-center">B2C & C2C Digital Resale Marketplace</span>
              </div>

              {/* Main Heading */}
              <div className={`space-y-4 sm:space-y-6 md:space-y-6 lg:space-y-6 xl:space-y-6 transform transition-all duration-1000 delay-200 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
                ...
                <p className="text-base sm:text-lg md:text-xl lg:text-xl xl:text-2xl text-gray-600 dark:text-gray-300 leading-relaxed">
                  Creators list limited digital products, buyers use or resell for profit. 
                  The only marketplace with a performance-driven resale system in the creator economy.
                </p>
              </div>

              {/* CTA Buttons */}
              <div className={`flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-4 lg:gap-4 xl:gap-4 transform transition-all duration-1000 delay-500 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
                <Button 
                  onClick={handleGetStarted}
                  className="group px-6 py-3 sm:px-8 sm:py-4 md:px-8 md:py-4 lg:px-8 lg:py-4 xl:px-8 xl:py-4 bg-flyverr-primary hover:bg-flyverr-primary text-white text-base sm:text-lg md:text-lg lg:text-lg xl:text-lg font-semibold rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105"
                >
                  Start Creating
                  <ArrowRight className="ml-2 w-4 h-4 sm:w-5 sm:h-5 md:w-5 md:h-5 lg:w-5 lg:h-5 xl:w-5 xl:h-5 group-hover:translate-x-1 transition-transform" />
                </Button>
                <Button 
                  ...
                  <div className="grid grid-cols-2 gap-2 sm:gap-3 md:gap-4 lg:gap-4 xl:gap-4">
                    ...
                    <div className="bg-blue-50 dark:bg-blue-900/30 dark:border dark:border-blue-800/50 rounded-xl sm:rounded-2xl md:rounded-2xl lg:rounded-2xl xl:rounded-2xl p-2 sm:p-3 md:p-4 lg:p-4 xl:p-4">
                      <div className="w-6 h-6 sm:w-8 sm:h-8 md:w-8 md:h-8 lg:w-8 lg:h-8 xl:w-8 xl:h-8 bg-blue-600 dark:bg-blue-500 rounded-lg flex items-center justify-center mb-2 sm:mb-3 md:mb-3 lg:mb-3 xl:mb-3">
                        <span className="text-white text-xs sm:text-sm md:text-sm lg:text-sm xl:text-sm">📚</span>
                      </div>
                      <h3 className="font-semibold text-gray-900 dark:text-white text-xs sm:text-sm md:text-sm lg:text-sm xl:text-sm mb-1">Digital eBooks</h3>
                      <p className="text-xs text-gray-600 dark:text-gray-300 mb-2">Knowledge & Learning</p>
                      <div className="flex items-center justify-between">
                        <span className="text-xs text-blue-600 dark:text-blue-400 bg-blue-100 dark:bg-blue-900/50 px-1 py-1 sm:px-2 sm:py-1 md:px-2 md:py-1 lg:px-2 lg:py-1 xl:px-2 xl:py-1 rounded-full">Limited Supply</span>
                      </div>
                    </div>
                    ...
                    <div className="bg-purple-50 dark:bg-purple-900/30 dark:border dark:border-purple-800/50 rounded-xl sm:rounded-2xl md:rounded-2xl lg:rounded-2xl xl:rounded-2xl p-2 sm:p-3 md:p-4 lg:p-4 xl:p-4">
                      ...
                      <h3 className="font-semibold text-gray-900 dark:text-white text-xs sm:text-sm md:text-sm lg:text-sm xl:text-sm mb-1">Online Courses</h3>
                      <p className="text-xs text-gray-600 dark:text-gray-300 mb-2">Expert Knowledge</p>
                      <div className="flex items-center justify-between">
                        <span className="text-xs text-purple-600 dark:text-purple-400 bg-purple-100 dark:bg-purple-900/50 px-1 py-1 sm:px-2 sm:py-1 md:px-2 md:py-1 lg:px-2 lg:py-1 xl:px-2 xl:py-1 rounded-full">Premium Content</span>
                      </div>
                    </div>
                    ...
                    <div className="bg-green-50 dark:bg-green-900/30 dark:border dark:border-green-800/50 rounded-xl sm:rounded-2xl md:rounded-2xl lg:rounded-2xl xl:rounded-2xl p-2 sm:p-3 md:p-4 lg:p-4 xl:p-4">
                      ...
                      <h3 className="font-semibold text-gray-900 dark:text-white text-xs sm:text-sm md:text-sm lg:text-sm xl:text-sm mb-1">Design Templates</h3>
                      <p className="text-xs text-gray-600 dark:text-gray-300 mb-2">Creative Assets</p>
                      <div className="flex items-center justify-between">
                        <span className="text-xs text-green-600 dark:text-green-400 bg-green-100 dark:bg-green-900/50 px-1 py-1 sm:px-2 sm:py-1 md:px-2 md:py-1 lg:px-2 lg:py-1 xl:px-2 xl:py-1 rounded-full">Professional</span>
                      </div>
                    </div>
                    ...
                    <div className="bg-orange-50 dark:bg-orange-900/30 dark:border dark:border-orange-800/50 rounded-xl sm:rounded-2xl md:rounded-2xl lg:rounded-2xl xl:rounded-2xl p-2 sm:p-3 md:p-4 lg:p-4 xl:p-4">
                      ...
                      <h3 className="font-semibold text-gray-900 dark:text-white text-xs sm:text-sm md:text-sm lg:text-sm xl:text-sm mb-1">Digital Music</h3>
                      <p className="text-xs text-gray-600 dark:text-gray-300 mb-2">Audio Content</p>
                      <div className="flex items-center justify-between">
                        <span className="text-xs text-orange-600 dark:text-orange-400 bg-orange-100 dark:bg-orange-900/50 px-1 py-1 sm:px-2 sm:py-1 md:px-2 md:py-1 lg:px-2 lg:py-1 xl:px-2 xl:py-1 rounded-full">Exclusive</span>
                      </div>
                    </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Unlike traditional marketplaces, our limited digital products increase in value over time. 
              Creators earn royalties on every resale, while buyers profit from appreciating assets.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className={`space-y-6 transform transition-all duration-1000 delay-300 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white">For Creators</h3>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 dark:text-white">List Limited Digital Products</h4>
                    <p className="text-gray-600 dark:text-gray-300">Upload eBooks, courses, templates, and more with controlled scarcity</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 dark:text-white">Earn Royalties on Resales</h4>
                    <p className="text-gray-600 dark:text-gray-300">Get paid every time your product is resold as its value increases</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 dark:text-white">Build Your Brand</h4>
                    <p className="text-gray-600 dark:text-gray-300">Grow your audience and establish yourself as a premium creator</p>
                  </div>
                </div>
              </div>
            ...
            <div className={`space-y-6 transform transition-all duration-1000 delay-500 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white">For Buyers & Investors</h3>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 dark:text-white">Invest in Appreciating Assets</h4>
                    <p className="text-gray-600 dark:text-gray-300">Purchase limited digital products that increase in value over time</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 dark:text-white">Profit from Resales</h4>
                    <p className="text-gray-600 dark:text-gray-300">Sell your digital assets when their value appreciates</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 dark:text-white">Access Premium Content</h4>
                    <p className="text-gray-600 dark:text-gray-300">Get exclusive digital products from top creators</p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 bg-white dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              The only digital marketplace where products appreciate in value, creators earn ongoing royalties, and buyers profit from limited supply scarcity.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-3">
                <h3 className="text-xl font-bold text-gray-900 dark:text-white">Limited Digital Products</h3>
                <p className="text-gray-600 dark:text-gray-300">
                  Sell limited digital products like ebooks, courses, templates, and software with controlled scarcity that drives value appreciation.
                </p>
              </div>

              {/* Benefit 2 */}
              <div className="space-y-3">
                <h3 className="text-xl font-bold text-gray-900 dark:text-white">Resale Ecosystem</h3>
                <p className="text-gray-600 dark:text-gray-300">
                  Once original licenses sell out, products become eligible for resale at higher prices. Creators earn ongoing royalties from every resale.
                </p>
              </div>
              ...
              {/* Benefit 4 */}
              <div className="space-y-3">
                <h3 className="text-xl font-bold text-gray-900 dark:text-white">Verified Reviews</h3>
                <p className="text-gray-600 dark:text-gray-300">
                  Trust authentic reviews from verified purchasers. 1-5 star rating system with admin moderation ensures quality.
                </p>
              </div>

              {/* Benefit 5 */}
              <div className="space-y-3">
                <h3 className="text-xl font-bold text-gray-900 dark:text-white">Secure Platform</h3>
                <p className="text-gray-600 dark:text-gray-300">
                  Stripe-powered payments, instant license delivery, and secure transaction processing for all digital assets.
                </p>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <div className="relative">
                ...
                <div className="absolute bottom-6 right-6 bg-white dark:bg-gray-800 rounded-xl p-4 shadow-lg max-w-48">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-900 dark:text-white">Digital assets that appreciate in value</p>
                      <p className="text-xs text-gray-600 dark:text-gray-400">Limited supply model</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-6 text-center">
                <h4 className="text-lg font-semibold text-gray-900 dark:text-white">Flyverr Platform</h4>
                <p className="text-gray-600 dark:text-gray-400">Where digital assets grow in value</p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center mt-16">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                Join thousands of creators and investors who are already profiting from appreciating digital assets.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button 
          onClick={handleGetStarted}
                  className="px-8 py-3 bg-flyverr-primary hover:bg-flyverr-primary/90 text-white font-semibold rounded-xl transition-all duration-300"
                >
                  Start Creating
                </Button>
                <Button 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="group bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-700">
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between mb-3">
                  <span className="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wide font-medium">Digital Course</span>
                  <div className="flex items-center">
                    <Star className="w-4 h-4 text-yellow-400 fill-current" />
                    <span className="text-sm text-gray-600 dark:text-gray-400 ml-1 font-medium">4.8</span>
                  </div>
                </div>
                ...
                <div className="flex items-center mb-4">
                  ...
                  <span className="text-sm text-gray-600 dark:text-gray-400">CodeMaster Pro</span>
                </div>
                
                {/* License Info */}
                <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-3 mb-4">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm text-gray-600 dark:text-gray-400">Licenses Available</span>
                    <span className="text-sm font-medium text-green-600 dark:text-green-400">50 of 100</span>
                  </div>
            ...
            <div className="group bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-700">
              ...
              <div className="p-6">
                {/* Category & Rating */}
                <div className="flex items-center justify-between mb-3">
                  <span className="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wide font-medium">Design System</span>
                  <div className="flex items-center">
                    <Star className="w-4 h-4 text-yellow-400 fill-current" />
                    <span className="text-sm text-gray-600 dark:text-gray-400 ml-1 font-medium">4.9</span>
                  </div>
                </div>
                ...
                <div className="flex items-center mb-4">
                  ...
                  <span className="text-sm text-gray-600 dark:text-gray-400">DesignStudio</span>
                </div>
                ...
                <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-3 mb-4">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm text-gray-600 dark:text-gray-400">Licenses Available</span>
                    <span className="text-sm font-medium text-orange-600 dark:text-orange-400">25 of 75</span>
                  </div>
                  <div className="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-2">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    <span className="text-2xl font-bold text-gray-900 dark:text-white">$149</span>
            ...
            <div className="group bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-700">
              ...
              <div className="p-6">
                {/* Category & Rating */}
                <div className="flex items-center justify-between mb-3">
                  <span className="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wide font-medium">Digital Guide</span>
                  <div className="flex items-center">
                    <Star className="w-4 h-4 text-yellow-400 fill-current" />
                    <span className="text-sm text-gray-600 dark:text-gray-400 ml-1 font-medium">4.7</span>
                  </div>
                </div>
                ...
                <div className="flex items-center mb-4">
                  ...
                  <span className="text-sm text-gray-600 dark:text-gray-400">MarketingGuru</span>
                </div>
                ...
                <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-3 mb-4">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm text-gray-600 dark:text-gray-400">Licenses Available</span>
                    <span className="text-sm font-medium text-red-600 dark:text-red-400">15 of 60</span>
                  </div>
                  <div className="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                The revolutionary digital marketplace where creators thrive and investors profit from appreciating digital assets.
              </p>
          ...
          <div className="border-t border-gray-800 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              ...
              <div className="text-gray-400 text-sm">
                © 2024 Flyverr. All rights reserved. Digital marketplace for appreciating assets.
              </div>
            ...
            <div className="mt-8 pt-8 border-t border-gray-800">
              <div className="max-w-md mx-auto text-center">
                ...
                <p className="text-gray-400 text-sm mb-4">
                  Get the latest updates on new products, market trends, and investment opportunities.
                </p>
