              ...
              <div className="space-y-2 sm:space-y-3 md:space-y-4 lg:space-y-5 xl:space-y-6">
                ...
                <div className="flex items-start space-x-2 sm:space-x-3 md:space-x-4 lg:space-x-4 xl:space-x-5">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-xs md:text-sm lg:text-base xl:text-lg text-gray-600 dark:text-gray-400">
                      Upload digital products with ease. Set pricing, licensing,
                      and scarcity controls to maximize value.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-2 sm:space-x-3 md:space-x-4 lg:space-x-4 xl:space-x-5">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-xs md:text-sm lg:text-base xl:text-lg text-gray-600 dark:text-gray-400">
                      Earn ongoing royalties every time your products are resold
                      in the marketplace. Passive income from your creativity.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-2 sm:space-x-3 md:space-x-4 lg:space-x-4 xl:space-x-5">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-xs md:text-sm lg:text-base xl:text-lg text-gray-600 dark:text-gray-400">
                      Monitor sales, revenue, and royalty earnings with detailed
                      analytics and insights to optimize your strategy.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-2 sm:space-x-3 md:space-x-4 lg:space-x-4 xl:space-x-5">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-xs md:text-sm lg:text-base xl:text-lg text-gray-600 dark:text-gray-400">
                      Stripe-powered payments with instant payouts and automated
                      royalty distribution for seamless transactions.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 py-10 sm:py-14 md:py-18 lg:py-20 xl:py-24">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xs sm:text-sm md:text-base lg:text-lg text-white/95 mb-4 sm:mb-6 md:mb-8 max-w-3xl mx-auto leading-relaxed">
              Start your journey to financial freedom. Upload your first product
              in minutes and join the digital economy revolution.
            </p>
